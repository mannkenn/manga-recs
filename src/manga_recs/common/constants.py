...
CLEANED_MANGA_METADATA_PARQUET = "cleaned_manga_metadata.parquet"
CLEANED_USER_READDATA_PARQUET = "cleaned_user_readdata.parquet"

MANGA_FEATURES_PARQUET = "manga_features.parquet"
